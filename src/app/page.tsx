...
function PlanetaryVisual() {
  return (
    <div className={styles.planetOrbit} aria-hidden="true">
      ...
      {/* Center birth star / sun */}
      <div className={styles.orbitCenter} />

      {/* Asymmetric planetary bodies of different sizes */}
      ...
      {/* Astrological constellation/intersecting lines and decorative details */}
...
export default function LandingPage() {
  return (
    <div className={styles.root}>
        ...
        <div className={styles.heroLayout}>
          ...
          <div className={styles.heroCopy}>
            ...
            <div className={styles.heroCtas}>
              <Link href="/onboarding" className={styles.ctaPrimary} id="hero-cta-main">
                <span className={styles.ctaWhatsapp}><WhatsAppIcon /></span>
                Quiero mi horóscopo
              </Link>
              <a href="#como-funciona" className={styles.ctaSecondary} id="hero-cta-how">
                Cómo funciona
              </a>
            </div>

            {/* Trust pills — concise, no marketing clichés */}
        ...
        <div className={styles.precisionInner}>
          <div className={styles.precisionText}>
            ...
            <h2 className={styles.precisionTitle}>
              Tu lectura parte de tu mapa,<br />
      ...
      {/* ── Cómo funciona — timeline editorial ──────────────────────────── */}
      <section id="como-funciona" className={`${styles.howSection} page-content`}>
        <div className={styles.sectionInner}>
          <p className={`label-upper ${styles.sectionLabel}`}>El proceso</p>
          <h2 className={`heading-lg ${styles.sectionTitle}`}>
            Una lectura diaria construida<br />
          ...
          <div className={styles.timeline}>
            ...
            <div className={styles.timelineStep}>
              ...
              <div className={styles.timelineContent}>
                ...
                <p className={styles.timelineDesc}>
                  ...
                  tránsitos actuales contra ese mapa para encontrar lo
                  que es relevante para vos.
                </p>
              </div>
            </div>
            ...
            <div className={`${styles.timelineStep} ${styles.timelineStepLast}`}>
              ...
              <div className={styles.timelineContent}>
                ...
                <p className={styles.timelineDesc}>
                  Antes de dormir, un mensaje privado con lo que el cielo
                  tiene para vos al día siguiente.
                </p>
              </div>
            </div>
      ...
      <section className={`${styles.previewSection} page-content`}>
        <div className={styles.sectionInner}>
          <p className={`label-upper ${styles.sectionLabel}`}>Tu lectura, cada noche</p>
          <h2 className={`heading-lg ${styles.sectionTitle}`}>
            Así se ve por dentro
          </h2>

          {/* Lectura premium card */}
          <div className={styles.readingCard}>
            ...
            <div className={styles.readingGrid}>
              <div className={styles.readingSection}>
                ...
                <div className={styles.readingSectionName}>Panorama general</div>
                <div className={styles.readingSectionBar}>
                  <div className={styles.readingSectionFill} style={{ width: '82%' }} />
                </div>
              ...
              <div className={styles.readingSection}>
                <div className={styles.readingSectionIcon}>♄</div>
                <div className={styles.readingSectionName}>Trabajo y dinero</div>
                <div className={styles.readingSectionBar}>
                  <div className={styles.readingSectionFill} style={{ width: '78%' }} />
                </div>
                <p className={styles.readingSectionText}>
              ...
              <div className={styles.readingSection}>
                ...
                <div className={styles.readingSectionBar}>
                  <div className={styles.readingSectionFill} style={{ width: '65%' }} />
                </div>
                <p className={styles.readingSectionText}>
              ...
              <div className={styles.readingSection}>
                <div className={styles.readingSectionIcon}>☽</div>
                <div className={styles.readingSectionName}>Energía interna</div>
                <div className={styles.readingSectionBar}>
                  <div className={styles.readingSectionFill} style={{ width: '71%' }} />
                </div>
                <p className={styles.readingSectionText}>
            ...
            <div className={styles.readingFooter}>
              <span className={styles.readingFooterLabel}>Base astrológica</span>
      ...
      <section className={`${styles.ctaSection} page-content`}>
        <div className={styles.ctaSectionInner}>
          <h2 className={styles.ctaSectionTitle}>
            Tu carta natal es única.<br />
            <em>Tu horóscopo también debería serlo.</em>
          </h2>
          <p className={styles.ctaSectionSub}>
            Empezá a recibir tu lectura personal cada noche, basada
            en tu mapa natal y los tránsitos del día.
          </p>
          <Link href="/onboarding" className={styles.ctaPrimary} id="final-cta">
            <span className={styles.ctaWhatsapp}><WhatsAppIcon /></span>
            Quiero mi horóscopo
          </Link>
          ...
          <div className={styles.trustGrid}>
            <div className={styles.trustItem}>
              ...
              <span className={styles.trustLabel}>Privado y confidencial</span>
            </div>
            <div className={styles.trustItem}>
              <span className={styles.trustIcon}>↩</span>
            ...
            <div className={styles.trustItem}>
              <span className={styles.trustIcon}>◇</span>
              <span className={styles.trustLabel}>Atención personalizada</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className={`${styles.footer} page-content`}>
        <div className={styles.footerInner}>
          <span className={styles.footerLogo}>✦ Astrologiqa</span>
          <p className={styles.footerText}>© 2025 — Todos los derechos reservados</p>
        </div>
      </footer>
    </div>
  );
